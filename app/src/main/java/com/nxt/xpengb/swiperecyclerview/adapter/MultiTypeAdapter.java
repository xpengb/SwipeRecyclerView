...
import com.nxt.xpengb.swiperecyclerview.viewholder.ViewHolderManager;
...
public class MultiTypeAdapter extends RecyclerViewAdapter {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (position == 0 && mViewCount == 1) {
            ...
            // 显示加载更多
            if (loadMoreAble && mLoadMoreBehavior != null && !isShowNoMore) {
